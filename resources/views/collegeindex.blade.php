...
@section('content')
<!-- Strat First Section -->
<div class="relative-div" style="background:url('{{ asset('college/images/VAF image 01.jpg') }}'); height:100vh;
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 coming">
                    ...
                    <button class="btn-form text-center" type="submit" value="Submit Form">REGISTER</button>
                </div>
            </div>
        </div>
    </div>
