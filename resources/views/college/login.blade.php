                ...
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            ...
                            <!-- <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required title="Must contain atleast 1 number & 1 uppercase & lowercase letter, & atleast 8 or more characters"> -->
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p>Don't have an account? <a href="{{ url('college/register') }}" class="text-primary m-l-5"><b>Sign Up</b></a></p>
                        </div>
                    </div>
                </form>
