                        ...
                        <div id="div2" style="display:none;">
                           ...
                           <div class ="col-md-3 col-sm-12 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control textbox ui-autocomplete-input search_courses" autocomplete="off" id="search_text" value="{{ $courses->course_offer }}" name="course_offer" placeholder="Course" required>
                              </div>
                           </div>
                           <div class ="col-md-3 col-sm-12 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control textbox ui-autocomplete-input search_department" value="{{ $courses->course_department }}" autocomplete="off" name="course_department" placeholder="Add Departments" required>
                              </div>
                           </div>
                           <div class ="col-md-3 col-sm-12 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control textbox" id="" name="course_duration" required value="{{ $courses->course_duration }}" placeholder="Duration Of Course" >
                              </div>
                           </div>
                           <div class ="col-md-3 col-sm-12 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control textbox" id="" name="course_total_fee" required value="{{ $courses->course_total_fee }}" placeholder="Overall Fee Of Course" >
                              </div>
                           </div>
                           <div class="col-md-6 col-sm-12 col-xs-12">
                              <div class="form-group">
                                 <label class="control-label m-t-10">Available Seats <span class="red">*</span></label>
                                 <input type="number" class="form-control textbox" id="" name="available_seat" required value="{{ $courses->available_seat }}" placeholder="Seats available for course" >
                              </div>
                           </div>
                           <div class ="col-md-6 col-sm-12 col-xs-12">
                              <div class="form-group">
                           ...
                           <div class="media" id="divcourse">
                              <div class="col-md-12 col-sm-12 col-lg-12">
                                 ...
                                 <div class="col-sm-9 col-md-9 col-xs-9">
                                    ...
                                    <div class ="col-md-4">
                                       <div class="form-group">
                                          <input type="text" class="form-control textbox" required value="{{ $faculties->faculty_name }}"  id="search_text" name="faculty_name[]" placeholder="Name of HOD" >
                                       </div>
                                    </div>
                                    <div class ="col-md-4">
                                       <div class="form-group">
                                          <input type="text" class="form-control textbox" required value="{{ $faculties->specialization }}"  id="search_text" name="specialization[]" placeholder="Specialized in" >
                                       </div>
                                    </div>
                                    <div class ="col-md-4">
                                       <div class="form-group">
                                        <select class="selectpicker" name="designation[]" required data-style="form-control btn-info btn-outline">
                                    ...
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="textarea" class="control-label">About Fadculty <span class="red">*</span></label>
