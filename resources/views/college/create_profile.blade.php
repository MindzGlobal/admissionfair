                        ...
                        <div class="wizard-content">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5">
                                        ...
                                        <input class="form-control" type="text" required name="university_name" id="txtBoxUn" />
                                        </div>
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-3 control-label">Category Of College <span class="red">*</span></label><br>
                                      <select class="select2 m-b-10 select2-multiple" required name="college_category[]" multiple="multiple" data-placeholder="Choose">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5">
                                        <input type="email" class="form-control" name="email" required placeholder="College Email ID" />
                                    </div>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-3 control-label">Mobile Number <span class="red">*</span></label>
                                    <div class="col-xs-5">
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-5">
                                            ...
                                            <select class="form-control" name="state" id="listBox" required onchange='selct_district(this.value)'></select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5">
                                        <textarea type="text" class="form-control" required name="college_address"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            ...
                            <div class="wizard-pane" role="tabpanel">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="input-file-max-fs" class="dropify" name="college_brochure" accept="image/gif, image/jpeg, image/png" data-max-file-size="5M"/>
                                    <label for="input-file-max-fs"><i>You can add a max file size 2MB</i></label>
                                    </div>
                                    </div>
                                </div>
