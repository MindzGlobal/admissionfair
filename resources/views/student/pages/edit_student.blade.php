...
@section('content')
   ...
   {{--  ?php include("common/header-hall.php")?>  --}}
      ...
      <div class="container wizardform">
         ...
         <br>
         <br>
         <form  action="{{ url('student/update_student') }}" method="post">
         @csrf
                  ...
                  <div class="col-md-12">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input  maxlength="100" name="first_name" type="text" required="required" class="form-control" placeholder="Enter First Name"  pattern="[A-Z a-z]{1,32}" value="{{ $students->first_name }}"/>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                           <label class="control-label">Last Name:</label>
                           <input  maxlength="100" type="text" name="last_name" required="required" class="form-control" placeholder="Enter Last Name"   value="{{ $students->last_name }}"/>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                           <label class="control-label">Email:</label>
                           <input  maxlength="100" type="email" name="email" required="required" class="form-control" placeholder="Enter Email"  value="{{ $students->email }}"/>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                           <label class="control-label">Contact Number:</label>
                           <input  maxlength="100" type="number" name="mobile" required="required" class="form-control" placeholder="Enter Contact Number"  value="{{ $students->mobile }}"/>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                           <label class="control-label">Date of birth:</label>
                           <input  maxlength="100" type="text" id="datepicker" name="date_of_birth"  required="required"  class="form-control" placeholder="Enter Date of birth"  value="{{ $students->date_of_birth }}"/>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <select name ="country" id ="country" class="form-control textbox"  class="required" / >
                            <option value="{{ $students->country }}">{{ $students->country }}</option>  
                           </select>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <option value="{{ $students->state }}">{{ $students->state }}</option> 
                           </select>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <select name ="city" id ="country" class="form-control textbox"  class="required"/ >
                           <option value="{{ $students->city }}">{{ $students->city }}</option> 
                           </select>
                        </div>
                     </div>
                     <div class="col-md-6">
